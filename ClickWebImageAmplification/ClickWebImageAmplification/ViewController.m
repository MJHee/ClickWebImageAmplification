...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
	...
	if ([requestString hasPrefix:@"myweb:imageClick:"]) {
		...
		CGFloat scale = imgWidth * 1.0 / [self getImageSizeWithURL:imageUrl].height;
		CGFloat imgHeight =  ScreenW * 1.0 / scale;
		self.imgView.width = ScreenW;
		self.imgView.height = imgHeight;
...
//    NSData *data = [urlSession dataTaskWithRequest:request completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
//        
//    }];
